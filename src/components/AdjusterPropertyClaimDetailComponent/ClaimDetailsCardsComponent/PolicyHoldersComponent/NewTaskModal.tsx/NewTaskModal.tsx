  ...
  return (
    <div>
      <form>
        ...
        <div className={clsx(modalStyle.alignItems, "row col-12 m-2")}>
          <div className={clsx(modalStyle.inputBoxAlign, "col-4")}>
            <label className={clsx(modalStyle.labelStyle, "mx-3")}>
              Uploaded Documents
            </label>
          </div>
        ...
        <div className={clsx("row col-12 m-2")}>
          <div className={clsx(modalStyle.alignRight, "row col-3")}>
